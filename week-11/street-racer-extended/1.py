...
class Enemy(pygame.sprite.Sprite): 
    ...
    '''
#Player class with func using sprite
class Player(pygame.sprite.Sprite): 
    ...
    def draw(self, surf): 
        surf.blit(self.image, self.rect)
    '''
#class coin with func using sprite    
...
while True: 
    for event in pygame.event.get():    
        if event.type == pygame.QUIT: 
            pygame.quit()
            sys.exit() 
    #picturing all surfaces, including sprite drawing
    ...
    for entity in all_sprites: 
        ...
        if not isinstance(entity, Coin): 
            entity.move()
    #sprite collision func, which works on rect pos to check it
